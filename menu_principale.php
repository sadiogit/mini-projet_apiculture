...
<body style="margin: 0%;
  padding : 0%;
        ...
        /*
				...
				if (isset($_SESSION['UserConnectSimple']))
					{
						header("location:menu_principale_simple_user.php");
					}
        */
			?>
  ...
  <div class="container" >
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="menu_principale.php">Gesto</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Confirmer<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="confirmation_vente.php">Commande</a></li>
            <li><a href="consultation_approv.php">Approvissionnement</a></li>
        ...
        <li class="dropdown">
          <a href="deconnexion.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Deconnexion</a>
